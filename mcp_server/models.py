...
class CertificateParameters(BaseModel):
    ...
    DocumentNumber: str = Field(
        ...
        examples=['01234567890/12345678901234567/AA11AA1111'],
    )
    ...
    PolicyNumber: str = Field(..., description='PolicyNumber', examples=['D0123456789'])
    SearchDocument: str = Field(
        ...,
        description='Select Any one form the list',
        examples=['Mobile Number,Chassis Number,Vehicle Registration Number'],
    )
